...
public class SetupDiscordBot extends ListenerAdapter {
    ...
    public void sendDirectLogs(int id, String type, String data, String username, String worldName, String location, String nonTranslateAction, String serverName) {
        ...
        boolean splitEnableForLog = plugin.getConfig().getBoolean("discord.enable-split-log-system") && !plugin.getConfig().getString("splitted-discord-logs." + nonTranslateAction).equals("-");
        String channelId = splitEnableForLog ? plugin.getConfig().getString("splitted-discord-logs." + nonTranslateAction) : plugin.getConfig().getString("discord.live_logs_channel_id");
